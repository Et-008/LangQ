...
export async function generateStaticParams() {
  const slugs = getSortedPostsData(); // Function to get all blog post slugs
  return slugs.map(({ id }) => ({
    id: id,
  }));
}
...
const BlogDetailsPage = async ({ params }: any) => {
  const response: any = await getPostData(params?.id);
              ...
              <div>
                ...
                <div className="mb-10 flex flex-wrap items-center justify-between border-b border-body-color border-opacity-10 pb-4 dark:border-white dark:border-opacity-10">
                    ...
                    <div className="mb-5 mr-10 flex items-center">
                      <div className="mr-4">
                        <div className="relative h-10 w-10 overflow-hidden rounded-full">
                          <Image
                            src={`/images/blog/${author.name}.png`}
                            alt="author"
                            fill
                          />
                        </div>
                  ...
                  <div className="mb-5">
                    <a
                      href="#0"
                      className="inline-flex capitalize items-center justify-center rounded-full bg-card px-4 py-2 text-sm font-semibold text-white"
                    >
                      {tags?.join(", ")}
                    </a>
                  </div>
