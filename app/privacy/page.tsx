...
const PrivacyPolicy = () => {
  return (
    <section className="max-w-3xl mx-auto px-4 py-12 text-gray-800 dark:text-gray-200 space-y-6">
      <div>
        <h1 className="text-3xl font-bold mb-8">Lang Q Privacy Policy</h1>
        <p>
          <strong>Effective Date:</strong> August 4, 2025
        </p>
        <p>
          At Lang Q, we respect your privacy and are committed to protecting
          your personal information. This policy explains how we collect, use,
          and protect your data when you use our Flutter localization platform.
        </p>
      </div>
      ...
      <div>
        ...
        <ul className="list-disc list-inside space-y-1">
          ...
          <li>
            ...
            including API calls, translation requests, and feature usage to
            improve our platform.
          </li>
          <li>
            <strong>Translation Content:</strong> The text, keys, and
            translations you create through our service.{" "}
            <strong>Important:</strong> We do not use your translation content
            to train AI models or share it with other users.
          </li>
          <li>
            <strong>Technical Data:</strong> IP address, browser type, device
            information, and error logs to maintain service quality and
            security.
          </li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul className="list-disc list-inside space-y-1">
          <li>
            <strong>Service Delivery:</strong> Process translations, manage your
            account, and provide customer support
          </li>
          <li>
            <strong>Service Improvement:</strong> Analyze usage patterns to
            improve features (using anonymized data only)
          </li>
          <li>
      ...
      <div>
        <h2 className="text-xl font-semibold mb-2">3. Your Translation Data</h2>
        <p>
          You own your content. We only process your translation keys and
          content to provide our localization services.
        </p>
      </div>
      ...
      <div>
        ...
        <ul className="list-disc list-inside space-y-1">
          <li>
            Service providers (hosting, payment processing, customer support
            tools)
          </li>
          <li>Legal authorities when required by law</li>
          <li>With your consent for specific integrations you enable</li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul className="list-disc list-inside space-y-1">
          ...
          <li>Export your translation data in standard formats</li>
      ...
      <div>
        ...
        <p>We use industry-standard security measures. We retain:</p>
        <ul className="list-disc list-inside space-y-1">
          <li>Active account data while your account exists</li>
          <li>Deleted account data for 30 days (for recovery)</li>
          <li>Usage logs for 12 months (anonymized after 30 days)</li>
        </ul>
      </div>
