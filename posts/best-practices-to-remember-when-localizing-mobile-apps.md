...
- Use tools like [Lang Q](https://lang-q.com) to allow linguists to **translate one page at a time with screenshots**, providing immediate context on where the text fits in the UI.
...
- Use a mobile Software Development Kit (SDK) like [Lang Q](https://lang-q.com)'s to deliver updates **over the air**.
