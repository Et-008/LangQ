            ...
            <div className="hero-badge">
              <div className="ai-indicator">
                <svg
                  ...
                  data-tag-assistant-prod-present="pending:1753986507335"
                >
                  <defs>
                  ...
                  <g className="cls-2">
                    <polygon
                      className="cls-4"
                      points="57.15 242.87 0 185.72 185.72 0 300 0 57.15 242.87"
                    />
                  </g>
                  <g className="cls-2">
                    <polygon
                  ...
                  <g className="cls-2">
                    <polygon
                      className="cls-6"
                      points="142.85 328.57 227.61 299.24 200.01 271.44 142.85 328.57"
                    />
                  </g>
                  <g className="cls-2">
                    <rect
